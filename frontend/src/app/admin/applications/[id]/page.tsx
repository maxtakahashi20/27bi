...
export default function AdminApplicationDetailPage() {
  ...
  return (
    <div className="max-w-3xl space-y-8">
      ...
      <form onSubmit={form.handleSubmit(onSave)} className="space-y-4 bg-ink-800/50 border border-olive-800/50 rounded-lg p-6 grid md:grid-cols-2 gap-4 text-sm">
        <label className="flex flex-col gap-1 md:col-span-2">
          <span className="text-olive-300/80">Nome completo</span>
          <input {...form.register("fullName")} className="bg-ink-900 border border-olive-800 rounded px-3 py-2" />
        </label>
        <label className="flex flex-col gap-1">
          <span className="text-olive-300/80">Idade</span>
          <input type="number" {...form.register("age")} className="bg-ink-900 border border-olive-800 rounded px-3 py-2" />
        </label>
        <label className="flex flex-col gap-1">
          <span className="text-olive-300/80">CPF</span>
          <input {...form.register("cpf")} className="bg-ink-900 border border-olive-800 rounded px-3 py-2" />
        </label>
        <label className="flex flex-col gap-1">
          <span className="text-olive-300/80">Discord (tag)</span>
          <input {...form.register("discordTag")} className="bg-ink-900 border border-olive-800 rounded px-3 py-2" />
        </label>
        <label className="flex flex-col gap-1">
          <span className="text-olive-300/80">Discord user ID (opcional, para DM)</span>
          <input {...form.register("discordUserId")} className="bg-ink-900 border border-olive-800 rounded px-3 py-2" placeholder="ex: 123456789012345678" />
        </label>
        <label className="flex flex-col gap-1">
          <span className="text-olive-300/80">Email</span>
          <input type="email" {...form.register("email")} className="bg-ink-900 border border-olive-800 rounded px-3 py-2" />
        </label>
        <label className="flex flex-col gap-1">
          <span className="text-olive-300/80">Telefone</span>
          <input {...form.register("phone")} className="bg-ink-900 border border-olive-800 rounded px-3 py-2" />
        </label>
        <label className="flex flex-col gap-1">
          <span className="text-olive-300/80">Cidade</span>
          <input {...form.register("city")} className="bg-ink-900 border border-olive-800 rounded px-3 py-2" />
        </label>
        <label className="flex flex-col gap-1">
          <span className="text-olive-300/80">Estado</span>
          <input {...form.register("state")} className="bg-ink-900 border border-olive-800 rounded px-3 py-2" />
        </label>
        <label className="flex flex-col gap-1 md:col-span-2">
          <span className="text-olive-300/80">Curso</span>
          <select {...form.register("courseId")} className="bg-ink-900 border border-olive-800 rounded px-3 py-2">
            {courses.map((c) => (
        ...
        <label className="flex flex-col gap-1 md:col-span-2">
          ...
          <textarea rows={2} {...form.register("experience")} className="bg-ink-900 border border-olive-800 rounded px-3 py-2" />
        </label>
        <label className="flex flex-col gap-1 md:col-span-2">
          <span className="text-olive-300/80">Motivação</span>
          <textarea rows={3} {...form.register("motivation")} className="bg-ink-900 border border-olive-800 rounded px-3 py-2" />
        </label>
        <label className="flex flex-col gap-1">
          <span className="text-olive-300/80">Status</span>
          <select {...form.register("status")} className="bg-ink-900 border border-olive-800 rounded px-3 py-2">
